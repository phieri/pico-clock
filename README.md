...
- The device hostname is also configured over the serial console with the `hostname <name>` command. If no value is provided, it resets to the default `ntp-clock` name.
